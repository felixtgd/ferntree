...
class SimTimeSeriesDoc(BaseModel):
    ...
    location: str = Field(
        title="Location", description="The location of the simulated system"
    )
...
# #     sim_params: SimParams = Field(title="Simulation Parameters", description="The simulation parameters")
