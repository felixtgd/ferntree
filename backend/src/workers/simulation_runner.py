...
async def run_simulation(sim_id: str, model_id: str) -> None:
    ...
    Args:
        sim_id (str): Identifier of the simulation to run.
        model_id (str): Identifier of the model to simulate.

    Returns:
        None: This function completes after the simulation finishes.
